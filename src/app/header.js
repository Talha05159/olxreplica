...
const mapDispatchToProps = (dispatch) => ({
 auth : () => dispatch(auth())
   ...
   export default 
       connect(mapStateToProps,mapDispatchToProps)(Appname);
